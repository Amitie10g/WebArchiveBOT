...
$public_html_path = $config['public_html_path'];
$json_file = $config['json_file'];
$json_file_cache = $config['json_file_cache'];
$json_file_max_size = $config['json_file_max_size'];
$email_operator = $config['email_operator'];
